...
class Notify:
    ...
    def send_emails_html(self):
        ...
        <body style='font-size:1.3em'>
            ...
            <p>You'll continue to receive notifications for this section <b>every 20 minutes</b> if spots are still available. To unsubscribe from notifications for this section, visit your <a href="https://snatch.tigerapps.org/dashboard">TigerSnatch Dashboard</a>.</p>
