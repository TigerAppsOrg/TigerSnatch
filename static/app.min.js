...
function(a){$("*").css("pointer-events","none");$("#right-wrapper").css("filter","blur(2px)")})},disableSwitchFunctions=function(){$(".waitlist-switch").attr("disabled",!0);$("*").css("pointer-events","none");$("*").css("cursor","wait")},enableSwitchFunctions=function(){$(".waitlist-switch").attr("disabled",!1);$("*").css("pointer-events","");$("*").css("cursor","")},switchListener=function(){$("input.waitlist-switch").change(function(a){a.preventDefault();classid=a.target.getAttribute("data-classid");
$("#confirm-remove-waitlist").attr("data-classid",classid);$("#close-waitlist-modal").attr("data-classid",classid);switchid="#switch-"+classid;n_tigers=$(this).closest("td").next("td");$(switchid).attr("checked")||(disableSwitchFunctions(),$.post("/add_to_waitlist/"+classid,function(b){2!==b.isSuccess&&(0===b.isSuccess?($("#close-waitlist-modal").modal("show"),$(switchid).attr("checked",!1),$(switchid).prop("checked",!1),enableSwitchFunctions()):(n_tigers.html(Number(n_tigers.html())+1),$(switchid).attr("checked",
!0),$(switchid).attr("data-bs-toggle","modal"),$(switchid).attr("data-bs-target","#confirm-remove-waitlist"),enableSwitchFunctions(),$(".toast-container").prepend(toastAdded.clone().attr("id","toast-added-"+ ++i)),$("#toast-added-"+i).toast("show")))}))})},modalConfirmListener=function(){$("#waitlist-modal-confirm").on("click",function(a){a.preventDefault();classid=$("#confirm-remove-waitlist").attr("data-classid");switchid="#switch-"+classid;disableSwitchFunctions();n_tigers=$(switchid).closest("td").next("td");
$.post("/remove_from_waitlist/"+classid,function(b){b.isSuccess&&(n_tigers.html(Number(n_tigers.html())-1),$(switchid+".dashboard-switch").closest("tr.dashboard-course-row").remove(),$(switchid).removeAttr("checked"),$(switchid).removeAttr("data-bs-toggle"),$(switchid).removeAttr("data-bs-target"),enableSwitchFunctions(),$(".toast-container").prepend(toastRemoved.clone().attr("id","toast-removed-"+ ++i)),$("#toast-removed-"+i).toast("show"))})})},modalCancelListener=function(){$("#waitlist-modal-cancel").on("click",
function(a){a.preventDefault();classid=$("#confirm-remove-waitlist").attr("data-classid");$("#switch-"+classid).prop("checked",!0)})},showAllListener=function(){$("#show-all-check").on("click",function(a){$(this).prop("checked")?($(".available-section-row").removeClass("d-none"),$("#no-full-message").addClass("d-none")):($(".available-section-row").addClass("d-none"),$("#no-full-message").removeClass("d-none"))})},pageBackListener=function(){$(window).on("popstate",function(){location.reload()})},
dashboardSkip=function(){$("#dashboard-skip").on("click",function(a){a.preventDefault();scrollBottom("#main")});-1!==window.location.href.indexOf("skip")&&$("#dashboard-skip").click()},searchSkip=function(){$("#search-skip").on("click",function(a){a.preventDefault();resetScroll("#main")})},initTooltipsToasts=function(){[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(a){return new bootstrap.Tooltip(a)});$("#status-indicator").on("click",function(a){a.preventDefault()});
$("#dev-warning").on("click",function(a){a.preventDefault()})},navbarAutoclose=function(){$(document).click(function(a){a=$(a.target);!$(".navbar-collapse").hasClass("show")||a.hasClass("navbar-toggler")||a.hasClass("nav-item")||a.hasClass("nav-button")||a.hasClass("nav-link")||$(".navbar-toggler").click()})},blacklistToastHelper=function(a){"success"===a?($(".toast-container").prepend(toastBlacklistSuccess.clone().attr("id","toast-blacklist-success-"+ ++i)),$("#toast-blacklist-success-"+i).toast("show"),
$("*").css("pointer-events","none"),setTimeout(function(){return location.reload()},3100)):"fail"===a&&($(".toast-container").prepend(toastBlacklistFail.clone().attr("id","toast-blacklist-fail-"+ ++i)),$("#toast-blacklist-fail-"+i).toast("show"))},blacklistListener=function(){$("button.btn-blacklist").on("click",function(a){a.preventDefault();confirm("Are you sure you want to blacklist this user?")&&(disableAdminFunction(),netid=a.target.getAttribute("data-netid"),$.post("/add_to_blacklist/"+netid,
function(b){b.isSuccess?blacklistToastHelper("success"):(enableAdminFunction(),blacklistToastHelper("fail"))}))})},blacklistRemovalListener=function(){$("button.btn-blacklist-removal").on("click",function(a){a.preventDefault();confirm("Are you sure you want to unblacklist this user?")&&(disableAdminFunction(),netid=a.target.getAttribute("data-netid"),$.post("/remove_from_blacklist/"+netid,function(b){b.isSuccess?blacklistToastHelper("success"):(blacklistToastHelper("fail"),enableAdminFunction())}))})},
getUserInfoListener=function(){$("button.btn-user-info").on("click",function(a){a.preventDefault();disableAdminFunction();netid=a.target.getAttribute("data-netid");$.post("/get_user_data/"+netid+"/false",function(b){if("missing"===b.data)$(".toast-container").prepend(toastUserDoesNotExist.clone().attr("id","toast-user-does-not-exist-"+ ++i)),$("#toast-user-does-not-exist-"+i).toast("show"),enableAdminFunction();else{b=b.data.split("{");$("#get-user-data-input").val("");dataHTML="";b=$jscomp.makeIterator(b);
for(var c=b.next();!c.done;c=b.next())dataHTML+='<p class="my-1">&#8594; '+c.value+"</p>";$("#modal-body-user-data").html(dataHTML);$("#user-data-waitlist-modal").modal("show")}$("#staticBackdropLabelUserData").html("Subscribed Sections for "+netid);enableAdminFunction()})})},getUsageSummaryListener=function(){$("#usage-summary").on("click",function(a){a.preventDefault();disableAdminFunction();$.post("/get_usage_summary",function(b){if("error"===b.data)enableAdminFunction();else{b=b.data.split("{");
dataHTML="";b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next())dataHTML+='<p class="my-1">&#8594; '+c.value+"</p>";$("#modal-body-usage-summary").html(dataHTML);$("#usage-summary-modal").modal("show")}enableAdminFunction()})})},enableAdminFunction=function(){$(".btn-blacklist").attr("disabled",!1);$(".btn-blacklist-removal").attr("disabled",!1);$(".btn-user-info").attr("disabled",!1);$("#usage-summary").attr("disabled",!1);$("#clear-all").attr("disabled",!1);$("#clear-all-trades").attr("disabled",
!1);$("#clear-all-logs").attr("disabled",!1);$("#update-term").attr("disabled",!1);$("#toggle-emails").attr("disabled",!1);$("#classid-clear-input").attr("disabled",!1);$("#classid-clear-submit").attr("disabled",!1);$("#courseid-clear-input").attr("disabled",!1);$("#courseid-clear-submit").attr("disabled",!1);$("#get-user-data-input").attr("disabled",!1);$("#get-user-data-submit").attr("disabled",!1);$("#fill-section-input").attr("disabled",!1);$("#get-user-trade-data-input").attr("disabled",!1);
$("#get-user-trade-data-submit").attr("disabled",!1);$("#fill-section-submit").attr("disabled",!1)},disableAdminFunction=function(){$(".btn-blacklist").attr("disabled",!0);$(".btn-blacklist-removal").attr("disabled",!0);$(".btn-user-info").attr("disabled",!0);$("#usage-summary").attr("disabled",!0);$("#clear-all").attr("disabled",!0);$("#clear-all-trades").attr("disabled",!0);$("#clear-all-logs").attr("disabled",!0);$("#update-term").attr("disabled",!0);$("#toggle-emails").attr("disabled",!0);$("#classid-clear-input").attr("disabled",
!0);$("#classid-clear-submit").attr("disabled",!0);$("#courseid-clear-input").attr("disabled",!0);$("#courseid-clear-submit").attr("disabled",!0);$("#get-user-data-input").attr("disabled",!0);$("#get-user-data-submit").attr("disabled",!0);$("#fill-section-input").attr("disabled",!0);$("#get-user-trade-data-input").attr("disabled",!0);$("#get-user-trade-data-submit").attr("disabled",!0);$("#fill-section-submit").attr("disabled",!0)},toggleEmailNotificationsListener=function(){$("#notifs-sheet-link").on("click",
function(a){a.preventDefault();window.open("https://docs.google.com/spreadsheets/d/1iSWihUcWa0yX8MsS_FKC-DuGH75AukdiuAigbSkPm8k/edit#gid=550138744","_blank")})},initToggleEmailNotificationsButton=function(){$.post("/get_notifications_status",function(a){a.isOn?$("#toggle-emails").html("Turn Off"):$("#toggle-emails").html("Turn On");enableAdminFunction()})},clearWaitlistsToastHelper=function(a){a.isSuccess?($(".toast-container").prepend(toastClearSuccess.clone().attr("id","toast-clear-success-"+ ++i)),
$("#toast-clear-success-"+i).toast("show")):($(".toast-container").prepend(toastClearFail.clone().attr("id","toast-clear-fail-"+ ++i)),$("#toast-clear-fail-"+i).toast("show"))},fillSectionToastHelper=function(a){a.isSuccess?($(".toast-container").prepend(toastFillSuccess.clone().attr("id","toast-clear-success-"+ ++i)),$("#toast-clear-success-"+i).toast("show")):($(".toast-container").prepend(toastFillFail.clone().attr("id","toast-clear-fail-"+ ++i)),$("#toast-clear-fail-"+i).toast("show"))},clearAllWaitlistsListener=
...
matchNetid+"/"+matchSection,function(e){$(".contact-button").attr("disabled",!1)}))});initTooltipsToasts()}else $("#match-"+courseid).html("We're unable to find you a Trade! If you haven't already, make sure to Subscribe to one or more sections for this course. Your Subscribed sections are the ones you'd like to trade into!");$("#matches-modal").modal("show");enableTradeFunction()})})},tradeFunctions=function(){updateCurrentSection();removeCurrentSection();findMatches()},mobileViewFunctions=function(){dashboardSkip();
searchSkip();navbarAutoclose()},adminFunctions=function(){blacklistListener();blacklistRemovalListener();updateTermListener();clearAllWaitlistsListener();clearAllTradesListener();clearAllLogsListener();clearClassWaitlistListener();clearCourseWaitlistListener();getUsageSummaryListener();getUserDataListener();getUserInfoListener();initToggleEmailNotificationsButton();toggleEmailNotificationsListener();fillSectionListener()},searchFunctions=function(){searchFormListener();searchResultListener()},subscriptionFunctions=
function(){switchListener();modalConfirmListener();modalCancelListener()};$(document).ready(function(){tradeFunctions();mobileViewFunctions();adminFunctions();searchFunctions();subscriptionFunctions();showAllListener();pageBackListener();initTooltipsToasts();dashboardCourseSelectListener()});
